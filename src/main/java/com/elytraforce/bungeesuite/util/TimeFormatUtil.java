...
public class TimeFormatUtil {
    ...
    public static long parseIntoMilliseconds(String duration) {
        ...
        ChronoUnit[] formattableUnit =
                new ChronoUnit[] { ChronoUnit.DAYS, ChronoUnit.HOURS, ChronoUnit.MINUTES, ChronoUnit.SECONDS };
        ...
        for (int i = 1; i < tokens.size(); i += 2) {
            ...
            try {
                ...
                time += MILLISECONDS.convert(value, TimeUnit.of(formattableUnit[suffixIndex]));
